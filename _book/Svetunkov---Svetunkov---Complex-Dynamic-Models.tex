...
\begin{verbatim}
##           x_r        x_i
## x_r 25.685678  -5.919869
## x_i -5.919869 104.832427
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -93.61365+ 1.42992i -45.51524+58.14337i
## y -45.51524+58.14337i   5.99959+46.33407i
\end{verbatim}
...
We start with the conventional OLS, which relies on the multiplication by conjugate number. For the simple CLR, it comes to minimising the following loss based on the residuals:
\begin{equation}
...
\begin{equation}
    \begin{aligned}
        & b_{1} = \frac{\sum_{j=1}^n (y_{j} \tilde{x}_j)}{\sum_{j=1}^n (x_{j} \tilde{x}_j)} \\
...
\begin{verbatim}
##            x_r         x_i         y_r         y_i
## x_r 1.00000000  0.04916944  0.65444978  0.68606061
## x_i 0.04916944  1.00000000 -0.71972390  0.75653173
## y_r 0.65444978 -0.71972390  1.00000000 -0.09532307
## y_i 0.68606061  0.75653173 -0.09532307  1.00000000
\end{verbatim}
