...
\begin{verbatim}
##           x_r        x_i
## x_r 31.061328  -2.441082
## x_i -2.441082 112.156714
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -97.09843+19.08039i -57.48301+65.66079i
## y -57.48301+65.66079i -15.49718+59.74525i
\end{verbatim}
...
\begin{verbatim}
##           x_r        x_i        y_r       y_i
## x_r 1.0000000  0.2135302  0.6917189 0.8150959
## x_i 0.2135302  1.0000000 -0.5538406 0.7365335
## y_r 0.6917189 -0.5538406  1.0000000 0.1498718
## y_i 0.8150959  0.7365335  0.1498718 1.0000000
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfcol=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{), }\AttributeTok{mar=}\FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(complexModel, }\AttributeTok{which=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfcol=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{), }\AttributeTok{mar=}\FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(complexModelLogs, }\AttributeTok{which=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot}\NormalTok{(complexModel, }\AttributeTok{which=}\DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
