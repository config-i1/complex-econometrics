...
\begin{verbatim}
##          x_r      x_i
## x_r 24.06523 -4.71271
## x_i -4.71271 90.80486
\end{verbatim}
...
\begin{verbatim}
##                     x                     y
## x -70.07154+ 0.17878i -29.500489+35.740599i
## y -29.50049+35.74060i  -0.953805+ 5.017298i
\end{verbatim}
...
\begin{verbatim}
##            x_r        x_i         y_r         y_i
## x_r  1.0000000 -0.1091968  0.73183643  0.64292535
## x_i -0.1091968  1.0000000 -0.75316761  0.68611604
## y_r  0.7318364 -0.7531676  1.00000000 -0.04464544
## y_i  0.6429254  0.6861160 -0.04464544  1.00000000
\end{verbatim}
...
\begin{equation}
    ...
    \end{aligned}
    \label{eq:AssumptionsRedundantOLS01}
\end{equation}
Substituting \(\underline{\mathbf{Z}} = \begin{pmatrix} \underline{\mathbf{X}} & \underline{\mathbf{X}}_{red} \end{pmatrix}\) and \(\underline{\mathbf{Z}}^\prime = \begin{pmatrix} \underline{\mathbf{X}}^\prime \\ \underline{\mathbf{X}}_{red}^\prime \end{pmatrix}\) in \eqref{eq:AssumptionsRedundantOLS01}, we get:
\begin{equation}
    \begin{aligned}
    \underline{\boldsymbol{c}}^{\text{OLS}} =
    ...
    \end{aligned}
    \label{eq:AssumptionsRedundantOLS02}
\end{equation}

The inverse block matrix in \eqref{eq:AssumptionsRedundantOLS02} is cumbersome, but each element of the resulting square block matrix can be written as:
\begin{equation}
    ...
    \label{eq:AssumptionsRedundantOLS03}
\end{equation}
...
\begin{equation}
    ...
    \label{eq:AssumptionsRedundantOLS04}
\end{equation}

If that happens, the redundant variable will explain the noise and thus our model will overfit the data and lead to inefficient estimates of parameters (i.e.~variances of estimates will be larger than needed).
