...
```{r complexPlaneMultiplication, fig.width=4, fig.height=4, fig.cap="Multiplication of a complex number by $i$ implies the rotation of it by $\\frac{\\pi}{2}$.", echo=FALSE}
