...
\begin{equation}
    x_{r} \in (\mu_{x_r} + \sigma_{x_r} z({\frac{\alpha}{2}}) , \mu_{x_r} + \sigma_{x_r} z({\frac{1+\alpha}{2}})),
    (\#eq:NormalInterval)
\end{equation}
where $z({\frac{\alpha}{2}})$ and $z({\frac{1+\alpha}{2}})$ are the respective lower and upper quantiles of the standard normal distribution.
