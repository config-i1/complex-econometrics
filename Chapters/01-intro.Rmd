...
```{r complexPlane, fig.width=5, fig.height=4, fig.cap="Visual presentation of a complex number on the complex plane.", echo=FALSE}
...
```{r complexPlanePolar, fig.width=5, fig.height=4, fig.cap="Visual presentation of a complex number in the polar coordinates.", echo=FALSE}
par(mar=c(1,1,1,1), cex=1.25, cex.lab=1/1.25)
plot(0,0, type="p",
     xlab="", ylab="",
