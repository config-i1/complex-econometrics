...
3. $x_r$ and $x_i$ are correlated with different variances ($\sigma_{x_r}=10$, while $\sigma_{x_i}=15$), $\epsilon_r$ and $\epsilon_i$ are equal to zero (i.e. $x$ and $y$ have functional relation).

4. $x_r$ and $x_i$ are correlated with different variances ($\sigma_{x_r}=10$, while $\sigma_{x_i}=15$), $\epsilon_r$ and $\epsilon_i$ are correlated with different variances.

5. $x_r$ and $x_i$ are correlated with different variances ($\sigma_{x_r}=10$, while $\sigma_{x_i}=15$), $\epsilon_r$ and $\epsilon_i$ are uncorrelated and have similar high variances ($\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=100$).

6. $x_r$ and $x_i$ are uncorrelated and have the same variances ($\sigma_{x_r}=\sigma_{x_i}=20$), $\epsilon_r$ and $\epsilon_i$ are uncorrelated and have the same variances ($\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5$).
...
nsim <- 9980
parametersValues <- array(NA, c(nsim,3,2),
                          dimnames=list(NULL,
...
```{r parametersUCDV, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 1.", echo=FALSE}
parametersPlots(parametersUCDV)
```

```{r parametersPC, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 2.", echo=FALSE}
parametersPlots(parametersPC)
```

```{r parametersFR, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 3.", echo=FALSE}
parametersPlots(parametersFR)
```

```{r parametersCorError, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 4.", echo=FALSE}
parametersPlots(parametersCorError)
```

```{r parametersHVError, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 5.", echo=FALSE}
parametersPlots(parametersHVError)
```

```{r parametersUCSV, fig.cap="Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of $b_1=2-1.5i$ (orange horizontal lines on the plot). Scenario 6.", echo=FALSE}
parametersPlots(parametersUCSV)
```



Ratio of variances for several sample sizes...
