...
\begin{verbatim}
##           x_r        x_i
## x_r 28.029548   3.024019
## x_i  3.024019 101.292767
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -60.82517+ 4.69324i -21.73856+62.98552i
## y -21.73856+62.98552i  46.73200+65.16135i
\end{verbatim}
...
\begin{verbatim}
##        x_r    x_i    y_r   y_i
## x_r  1.000 -0.007  0.738 0.734
## x_i -0.007  1.000 -0.677 0.671
## y_r  0.738 -0.677  1.000 0.088
## y_i  0.734  0.671  0.088 1.000
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SeatbeltsComplex}\SpecialCharTok{$}\NormalTok{seasonal }\OtherTok{\textless{}{-}} \FunctionTok{temporaldummy}\NormalTok{(SeatbeltsComplex[,}\DecValTok{1}\NormalTok{],}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SeatbeltscLR01 }\OtherTok{\textless{}{-}} \FunctionTok{clm}\NormalTok{(}\FunctionTok{I}\NormalTok{(}\FunctionTok{clog}\NormalTok{(y))}\SpecialCharTok{\textasciitilde{}}\FunctionTok{log}\NormalTok{(kms)}\SpecialCharTok{+}\FunctionTok{log}\NormalTok{(PetrolPrice)}\SpecialCharTok{+}\NormalTok{law}\SpecialCharTok{+}\NormalTok{seasonal,}
...
\FunctionTok{names}\NormalTok{(SeatbeltscLRList) }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{"ARIMA("}\NormalTok{,}\FunctionTok{apply}\NormalTok{(cARIMAOrders, }\DecValTok{1}\NormalTok{, paste0, }\AttributeTok{collapse=}\StringTok{","}\NormalTok{),}\StringTok{")"}\NormalTok{)}

\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(cARIMAOrders))\{}
\NormalTok{    SeatbeltscLRList[[i]] }\OtherTok{\textless{}{-}} \FunctionTok{clm}\NormalTok{(}\FunctionTok{I}\NormalTok{(}\FunctionTok{clog}\NormalTok{(y))}\SpecialCharTok{\textasciitilde{}}\FunctionTok{log}\NormalTok{(kms)}\SpecialCharTok{+}\FunctionTok{log}\NormalTok{(PetrolPrice)}\SpecialCharTok{+}\NormalTok{law}\SpecialCharTok{+}\NormalTok{seasonal,}
\NormalTok{                                 SeatbeltsComplex, }\AttributeTok{orders=}\NormalTok{cARIMAOrders[i,], }\AttributeTok{maxeval=}\DecValTok{1000}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:seatbeltsDataModelFinal}Number of drivers killed and injured and the fitted values from the \texttt{r\ SeatbeltscLRList{[}{[}iBest{]}{]}\$model} model.}
\end{figure}
