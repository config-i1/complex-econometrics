...
The literature knows two correlation coefficients for complex variables \citep{ref}: the conventional correlation and the pseudo-correlation. In this monograph, we will call the latter ``complex correlation''. Their formula are based on the respective covariances and variances (conventional and pseudo discussed in Subsection \ref{crvSecondMoment}):
