...
\begin{verbatim}
##           x_r        x_i
## x_r 29.617492   0.312761
## x_i  0.312761 122.475179
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -90.46740+14.36533i -46.22346+79.14255i
## y -46.22346+79.14255i   9.87479+38.70749i
\end{verbatim}
...
\begin{verbatim}
##           x_r        x_i        y_r        y_i
## x_r 1.0000000  0.0118843  0.6577379  0.6777723
## x_i 0.0118843  1.0000000 -0.7411116  0.7391809
## y_r 0.6577379 -0.7411116  1.0000000 -0.1019670
## y_i 0.6777723  0.7391809 -0.1019670  1.0000000
\end{verbatim}
...
\begin{equation}
    \begin{aligned}
        ...
        & \left( \underline{\mathbf{X}}^\prime \underline{\mathbf{X}} \right)^{-1} \underline{\mathbf{X}}^\prime \left( \tilde{\underline{\mathbf{X}}}^\prime \tilde{\underline{\mathbf{X}}} \right)^{-1} \tilde{\underline{\mathbf{X}}}^\prime \mathrm{cov}\left( \underline{\boldsymbol{\epsilon}}, \tilde{\underline{\boldsymbol{\epsilon}}} \right) = \\
        & \left( \underline{\mathbf{X}}^\prime \underline{\mathbf{X}} \right)^{-1} \underline{\mathbf{X}}^\prime \left( \tilde{\underline{\mathbf{X}}}^\prime \tilde{\underline{\mathbf{X}}} \right)^{-1} \tilde{\underline{\mathbf{X}}}^\prime \sigma_{\underline{\epsilon}}^2 ,
    \end{aligned}
    \label{eq:MCLROLSConjVar}
\end{equation}
where the expectations of each term are equal to zero as long as the classical regression assumptions hold and \(\sigma_{\underline{\epsilon}}^2\) is the conjugate variance of the error term. Using the same logic, it can be shown that the direct variances of parameters can be calculated as:
\begin{equation}
    \begin{aligned}
        \mathcal{V}\left( \underline{\boldsymbol{b}}^{\text{OLS}} \right) =
        & \left( \underline{\mathbf{X}}^\prime \underline{\mathbf{X}} \right)^{-1} \sigma_{\underline{\epsilon}}^2 .
    \end{aligned}
    \label{eq:MCLROLSDirVar}
\end{equation}
Finally, in a similar fashion, conjugate and direct variances can be calculated for the CLS estimates of parameters:
\begin{equation}
    \begin{aligned}
        \mathrm{V}\left( \underline{\boldsymbol{b}}^{\text{CLS}} \right) =
        & \left( \underline{\mathbf{X}}^\top \underline{\mathbf{X}} \right)^{-1} \underline{\mathbf{X}}^\top \left( \tilde{\underline{\mathbf{X}}}^\top \tilde{\underline{\mathbf{X}}} \right)^{-1} \tilde{\underline{\mathbf{X}}}^\top \sigma_{\underline{\epsilon}}^2 .
    \end{aligned}
