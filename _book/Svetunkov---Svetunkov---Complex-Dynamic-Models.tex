...
\begin{verbatim}
##           x_r        x_i
## x_r 26.831658  -3.131281
## x_i -3.131281 101.083901
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -68.11650+10.87831i -32.17985+60.81693i
## y -32.17985+60.81693i  52.70734+60.53776i
\end{verbatim}
...
\begin{verbatim}
##        x_r    x_i    y_r    y_i
## x_r  1.000 -0.215  0.749  0.577
## x_i -0.215  1.000 -0.805  0.671
## y_r  0.749 -0.805  1.000 -0.103
## y_i  0.577  0.671 -0.103  1.000
\end{verbatim}
...
\NormalTok{e }\OtherTok{\textless{}{-}} \FunctionTok{rcnorm}\NormalTok{(obs, }\AttributeTok{mu=}\DecValTok{0}\NormalTok{, }\AttributeTok{sigma2=}\DecValTok{10}\NormalTok{, }\AttributeTok{varsigma2=}\DecValTok{8}\SpecialCharTok{+}\NormalTok{5i)}
...
## (Intercept)_r  105.8255    13.4099    79.2105    132.4405 *
## (Intercept)_i -152.0522     4.9475  -161.8716   -142.2328 *
## x1_r             2.4508     0.0567     2.3383      2.5633 *
## x1_i             1.5291     0.0209     1.4876      1.5706 *
## x2_r             1.5368     0.0516     1.4343      1.6393 *
## x2_i            -0.7309     0.0191    -0.7687     -0.6931 *
## 
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  103.2425   150.5863  -195.6296    402.1146  
## (Intercept)_i -296.1699   148.5077  -590.9166     -1.4233 *
## x1_r             3.1544     0.9439     1.2810      5.0278 *
## x1_i             2.1119     0.9648     0.1972      4.0267 *
## x2_r             1.5650     0.2584     1.0523      2.0778 *
## x2_i            -0.8831     0.2438    -1.3669     -0.3992 *
## 
## Error covariance matrix:
##         e_r    e_i
## e_r 14.3697 2.3138
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  105.7571    13.5160    78.9262    132.5880 *
## (Intercept)_i -152.0258     4.9830  -161.9176   -142.1340 *
## x1_r             2.4513     0.0571     2.3379      2.5647 *
## x1_i             1.5287     0.0211     1.4869      1.5705 *
## x2_r             1.5364     0.0521     1.4331      1.6397 *
## x2_i            -0.7310     0.0192    -0.7691     -0.6929 *
## 
## Error covariance matrix:
##        e_r    e_i
## e_r 6.2388 1.6767
...
##      AIC     AICc      BIC     BICc 
## 658.1565 658.6803 669.8797 671.0858
\end{verbatim}
