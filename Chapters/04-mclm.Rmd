...
```{r}
EnglandComplex <- data.frame(y=complex(real=EnglandPF$GDP, imaginary=EnglandPF$DDP),
                             x=complex(real=EnglandPF$Capital, imaginary=EnglandPF$Labour))
sapply(EnglandComplex, cscale, scaling="standardisation") -> EnglandComplexScaled
```
...
```{r}
EnglandcLR <- clm(log(y)~log(x)+trend, EnglandComplexScaled)
```
