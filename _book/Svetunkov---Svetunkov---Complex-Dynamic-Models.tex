...
\begin{verbatim}
##          x_r       x_i
## x_r 24.89950  10.14105
## x_i 10.14105 106.77118
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -88.39831+12.14880i -36.42057+66.34435i
## y -36.42057+66.34435i  22.57633+62.22312i
\end{verbatim}
...
\begin{equation}
    \begin{aligned}
        & \underline{b_1} = \frac{\sum_{j=1}^n (y_{j}-\underline{\hat{\mu}_{y}}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})}{\sum_{j=1}^n (x_{j}-\underline{\hat{\mu}_{x}}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})} \\
...
\begin{equation}
    \begin{aligned}
        & \underline{b_1} = \frac{\sum_{j=1}^n (\underline{y_{j}}-\underline{\hat{\mu}_{y}}) (\underline{{x}_j}-\underline{\hat{\mu}_{x}})}{\sum_{j=1}^n (x_{j}-\underline{\hat{\mu}_{x}})^2} \\
        & \underline{b_0} = \frac{1}{n} \sum_{j=1}^n \underline{y_j} - \underline{b_1} \sum_{j=1}^n \underline{x_j} ,
    \end{aligned}
...
\begin{verbatim}
##             x_r         x_i        y_r        y_i
## x_r  1.00000000 -0.09746876  0.7193683  0.6461915
## x_i -0.09746876  1.00000000 -0.7575749  0.6944301
## y_r  0.71936835 -0.75757486  1.0000000 -0.0604329
## y_i  0.64619154  0.69443014 -0.0604329  1.0000000
\end{verbatim}
