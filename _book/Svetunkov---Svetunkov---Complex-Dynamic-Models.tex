...
\begin{verbatim}
## Warning in text.default(1, 1.5, TeX("$\\frac{π}{2}$"), pos = 3, cex = 0.8): font
## metrics unknown for Unicode character U+03c0
...
\begin{verbatim}
## Warning in text.default(1, 1.5, TeX("$\\frac{π}{2}$"), pos = 3, cex = 0.8):
...
\caption{\label{fig:complexPlaneMultiplication}Multiplication of a number by \(i\).}
\end{figure}
...
\caption{\label{fig:complexPlaneCircle}Visual presentation of a complex number on the complex plane.}
\end{figure}
