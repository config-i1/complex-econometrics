...
\begin{verbatim}
##           x_r        x_i
## x_r 20.521396   1.504584
## x_i  1.504584 112.082329
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -88.32587+14.97969i -44.53615+66.61220i
## y -44.53615+66.61220i  13.82186+82.12759i
\end{verbatim}
...
\end{equation}
where every parameter and variable is a complex number, i.e.~\(y = y_{r}+i y_i\), \(x = x_{r}+i x_i\), \(b_{j} = b_{j,r} + i b_{j,i}\) and \(\epsilon = \epsilon_{r} + i \epsilon_i\). Inserting these values in \eqref{eq:SimpleCLRComplex} leads to:
\begin{equation}
    y_r + i y_i = (b_{0,r} + i b_{0,i}) + (b_{1,r} + i b_{1,i}) (x_{r}+i x_i) + (\epsilon_r + i \epsilon_i)
    \label{eq:SimpleCLR}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        y_r = & b_{0,r} + b_{1,r} x_r - b_{1,i} x_i + \epsilon_r \\
        y_i = & b_{0,i} + b_{1,r} x_i + b_{1,i} x_r + \epsilon_i
    \end{aligned}
...
\begin{verbatim}
##             x_r         x_i         y_r        y_i
## x_r  1.00000000 -0.02658205  0.73009802 0.70165006
## x_i -0.02658205  1.00000000 -0.69785513 0.69020317
## y_r  0.73009802 -0.69785513  1.00000000 0.03040018
## y_i  0.70165006  0.69020317  0.03040018 1.00000000
\end{verbatim}
