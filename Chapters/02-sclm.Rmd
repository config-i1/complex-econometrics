...
\begin{equation}
        b_{1} = \frac{\mathrm{cov}(x, y)}{\mathrm{V}(x)} = \frac{\mathrm{cov}(x, \beta_0 + \beta_1 x + \epsilon)}{\mathrm{V}(x)} = \frac{\mathrm{cov}(x, \beta_0) + \mathrm{cov}(x, \beta_1 x) + \mathrm{cov}(x, \epsilon)}{\mathrm{V}(x)},
    (\#eq:SimpleCLROLSb1Value01)
\end{equation}
which then simplifies to:
\begin{equation}
        b_{1} = \beta_1 + \frac{\mathrm{cov}(x, \epsilon)}{\mathrm{V}(x)} = \beta_1 + \frac{\hat{\sigma}_{x,\epsilon}}{\hat{\sigma}_x^2} ,
