...
In this case, modelling can be done in the exponential form of the complex variable, which might allow capturing complicated non-linear relations between variables.
