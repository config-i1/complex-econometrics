...
\begin{verbatim}
##           x_r        x_i
## x_r 20.927027  -3.598709
## x_i -3.598709 114.439503
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -89.99089- 2.34275i -47.96240+68.82301i
## y -47.96240+68.82301i  47.33523+78.60882i
\end{verbatim}
...
\hypertarget{comparing-different-estimators}{%
\subsection{Comparing different estimators}\label{comparing-different-estimators}}
...
In order to do that, we set up several experiments with the following settings\ldots{}

\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/parametersCorError-1.pdf}
\caption{\label{fig:parametersCorError}Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of \(b_1=2-1.5i\) (orange horizontal lines on the plot)}
\end{figure}

Ratio of variances for several sample sizes\ldots{}

\hypertarget{correlation-analysis-of-complex-random-variables}{%
\chapter{Correlation analysis of complex random variables}\label{correlation-analysis-of-complex-random-variables}}
...
\section{Conjugate and Direct correlations}\label{conjugate-and-direct-correlations}}
...
\begin{verbatim}
##           x_r        x_i         y_r        y_i
## x_r 1.0000000  0.1060104  0.69781663 0.76507162
## x_i 0.1060104  1.0000000 -0.63376980 0.71780021
## y_r 0.6978166 -0.6337698  1.00000000 0.07782119
## y_i 0.7650716  0.7178002  0.07782119 1.00000000
\end{verbatim}
...
\hypertarget{simpleCLR}{%
\chapter{Multiple Complex Linear Regression}\label{simpleCLR}}
