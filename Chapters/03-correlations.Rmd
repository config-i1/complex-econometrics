...
2. When the complex variables $x$ and $y$ have functional relation between them, so that $a_1 = \frac{1}{b_1}$, the coefficient will be equal to one.
