...
\begin{verbatim}
##           x_r       x_i
## x_r 22.537097  5.229454
## x_i  5.229454 86.233909
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -61.49841- 5.50747i -45.64823+42.02830i
## y -45.64823+42.02830i -19.69605+51.96152i
\end{verbatim}
...
\begin{verbatim}
##           x_r        x_i         y_r         y_i
## x_r 1.0000000  0.1644873  0.62072799  0.75340202
## x_i 0.1644873  1.0000000 -0.66740562  0.76877451
## y_r 0.6207280 -0.6674056  1.00000000 -0.04212291
## y_i 0.7534020  0.7687745 -0.04212291  1.00000000
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/unnamed-chunk-26-1.pdf}
\caption{\label{fig:unnamed-chunk-26}Non-linear transformation of a complex variable that changes linearly.}
\end{figure}
...
Furthermore, there might be issues related to the calculation of the covariance matrix of parameters (discussed in Section \ref{MCLRInference}), where we need both direct and conjugate covariance matrices:
...
\NormalTok{x2 }\OtherTok{\textless{}{-}} \FunctionTok{complex}\NormalTok{(}\AttributeTok{real=}\FunctionTok{Im}\NormalTok{(x1)}\SpecialCharTok{*}\FloatTok{1.5} \SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(obs,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{), }\AttributeTok{imaginary=}\FunctionTok{Re}\NormalTok{(x1)}\SpecialCharTok{*}\FloatTok{2.5} \SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(obs,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\CommentTok{\# Generate parameters}
...
\CommentTok{\# Form data frame with the variables}
\NormalTok{xreg }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{y=}\NormalTok{y,}\AttributeTok{x1=}\NormalTok{x1,}\AttributeTok{x2=}\NormalTok{x2)}
\end{Highlighting}
\end{Shaded}

Diagnostic based on correlation matrices

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ccor}\NormalTok{(xreg,}\AttributeTok{method=}\StringTok{"conjugate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##            y        x1        x2
## y  1.0000000 0.8228126 0.8572564
## x1 0.8228126 1.0000000 0.7671853
## x2 0.8572564 0.7671853 1.0000000
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ccor}\NormalTok{(xreg,}\AttributeTok{method=}\StringTok{"direct"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##                      y                 x1                  x2
## y  -1.000000+0.000000i 1.074216+0.007260i -1.012863+0.073839i
## x1  1.074216+0.007260i 1.000000+0.000000i  1.312030+0.013922i
## x2 -1.012863+0.073839i 1.312030+0.013922i -1.000000+0.000000i
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ccor}\NormalTok{(xreg,}\AttributeTok{method=}\StringTok{"pearson"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##                             y                         x1
## y   1.00000000000000000000000 -0.00000000000000001682260
## x1 -0.00000000000000001682260  1.00000000000000000000000
## x2  0.00000000000000001672479 -0.00000000000000005076893
##                            x2
## y   0.00000000000000001672479
## x1 -0.00000000000000005076893
## x2  1.00000000000000000000000
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{covar}\NormalTok{(xreg) }\SpecialCharTok{|\textgreater{}} \FunctionTok{cov2cor}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##             y_r        y_i        x1_r        x1_i        x2_r        x2_i
## y_r  1.00000000 0.83977321  0.92176975  0.01363040  0.01417034  0.92135701
## y_i  0.83977321 1.00000000  0.87546190  0.05523320  0.04359793  0.87757009
## x1_r 0.92176975 0.87546190  1.00000000 -0.05950187 -0.06185004  0.99914162
## x1_i 0.01363040 0.05523320 -0.05950187  1.00000000  0.98892512 -0.05318074
## x2_r 0.01417034 0.04359793 -0.06185004  0.98892512  1.00000000 -0.05661347
## x2_i 0.92135701 0.87757009  0.99914162 -0.05318074 -0.05661347  1.00000000
\end{verbatim}

Fit CLR using different estimation methods

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{clm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{., xreg, }\AttributeTok{loss=}\StringTok{"OLS"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
## (Intercept)_r  109.8449    27.7373    54.7941    164.8957 *
## (Intercept)_i -144.5184    43.3637  -230.5834    -58.4535 *
## x1_r             2.4667     0.2555     1.9597      2.9737 *
## x1_i             1.5535     0.3994     0.7608      2.3462 *
## x2_r             1.4715     0.1082     1.2567      1.6863 *
## x2_i            -0.7395     0.1692    -1.0754     -0.4037 *
## 
## Error covariance matrix:
##          e_r      e_i
## e_r 338.6123  79.0614
## e_i  79.0614 827.6144
## 
## Sample size: 100
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{clm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{., xreg, }\AttributeTok{loss=}\StringTok{"CLS"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  113.1617    27.9232    57.7420    168.5815 *
## (Intercept)_i -143.9751    43.5352  -230.3804    -57.5698 *
## x1_r             2.4535     0.3931     1.6732      3.2337 *
## x1_i             1.5788     0.2701     1.0428      2.1149 *
## x2_r             1.4619     0.1222     1.2193      1.7044 *
## x2_i            -0.7396     0.1608    -1.0588     -0.4205 *
## 
## Error covariance matrix:
##          e_r      e_i
## e_r 338.6168  79.0514
## e_i  79.0514 827.6653
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{clm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{., xreg, }\AttributeTok{loss=}\StringTok{"like"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   54.8797    27.9541    -0.6125    110.3720  
## (Intercept)_i -129.5050    43.7030  -216.2606    -42.7493 *
## x1_r             2.4648     0.2575     1.9537      2.9759 *
## x1_i             1.5535     0.4025     0.7545      2.3525 *
## x2_r             1.4708     0.1091     1.2543      1.6874 *
## x2_i            -0.7395     0.1705    -1.0781     -0.4010 *
## 
## Error covariance matrix:
##          e_r      e_i
## e_r 343.9281  80.2997
## e_i  80.2997 840.6171
## 
## Sample size: 100
...
##      AIC     AICc      BIC     BICc 
## 1822.568 1823.092 1834.291 1835.497
\end{verbatim}

Solving the multicollinearity is not a trivial problem on its own. In general, it can be done either by dropping some of the most correlated variables, or by applying some techniques for dimensionality reduction (such as Principle Components Analysis). These methods are standard and we do not discuss them in this monograph.
