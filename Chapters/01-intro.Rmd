...
The theory of complex numbers originates in 1572 in a small Italian town of Kura. It was in that place and precisely that year that the manuscript of an Italian mathematician Rafael Bombelli was published [@Bombelli1572]. The book was called "Algebra". In it, Rafael Bombelli showed how to solve the following cubic equation:
\begin{equation}
    x^3 = 15x + 4 .
    (\#eq:BombelliEquation)
\end{equation}
