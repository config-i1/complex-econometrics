...
\begin{verbatim}
##           x_r        x_i
## x_r 26.319635   4.188822
## x_i  4.188822 109.215002
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -87.97631+17.60711i -33.41384+55.28347i
## y -33.41384+55.28347i  22.86743+64.97267i
\end{verbatim}
...
\begin{verbatim}
##             x_r         x_i         y_r        y_i
## x_r  1.00000000 -0.04808358  0.74384924 0.71819141
## x_i -0.04808358  1.00000000 -0.70002796 0.65735887
## y_r  0.74384924 -0.70002796  1.00000000 0.07419228
## y_i  0.71819141  0.65735887  0.07419228 1.00000000
\end{verbatim}
...
To diagnose this, we can analyse the autocorrelation functions. In the real-valued domain, Autocorrelation Function (ACF) and the Partial Autocorrelation Function (PACF) are typically used. In the complex-valued domain, these transform to the direct and conjugate ACF/PACF (based on the correlations discussed in Chapter \ref{correlationAnalysis}), giving an analyst four instruments instead of two.
