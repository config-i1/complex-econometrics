...
**To do**:
Derive biases for the following cases:

1. Omitted variables should be included in the real part and is correlated with another real part of a variable;
2. Omitted variables should be included in the real part and is correlated with the imaginary part of a variable;
3. Omitted variables should be included in the imaginary part and is correlated with the real part of a variable;
4. Omitted variables should be included in the imaginary part and is correlated with another imaginary part of a variable;
5. Omitted variables is complex and is correlated with another complex variable.
