...
\begin{verbatim}
##           x_r        x_i
## x_r 24.704724   6.107203
## x_i  6.107203 116.679760
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -80.28436+ 1.57939i -23.00167+58.98828i
## y -23.00167+58.98828i  41.07806+39.96565i
\end{verbatim}
...
\begin{verbatim}
##       x_r    x_i    y_r    y_i
## x_r 1.000  0.025  0.628  0.651
## x_i 0.025  1.000 -0.760  0.772
## y_r 0.628 -0.760  1.000 -0.177
## y_i 0.651  0.772 -0.177  1.000
\end{verbatim}
...
\section{CLR with a trend}\label{DynamicTrend}}
...
\begin{equation}
    t^{\underline{\gamma}} = \exp (\underline{\gamma} \ln t) = \exp (\gamma_r \ln t) \exp (i \gamma_i \ln t),
    \label{eq:trendExp}
\end{equation}
...
\hypertarget{complex-arma}{%
\section{Complex ARMA}\label{complex-arma}}
