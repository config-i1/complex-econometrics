...
\hypersetup{
  pdftitle={Complex-valued Econometrics},
...
\begin{verbatim}
##           x_r       x_i
## x_r 22.798650 -3.542407
## x_i -3.542407 90.148770
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -71.57956+15.92924i -22.75222+42.87499i
## y -22.75222+42.87499i -22.00371+ 0.57081i
\end{verbatim}
...
\begin{verbatim}
##            x_r         x_i         y_r        y_i
## x_r 1.00000000  0.08909765  0.69553710 0.74490928
## x_i 0.08909765  1.00000000 -0.65016249 0.72860078
## y_r 0.69553710 -0.65016249  1.00000000 0.04335548
## y_i 0.74490928  0.72860078  0.04335548 1.00000000
\end{verbatim}
...
\begin{equation*}
    \hat{\boldsymbol{\Sigma}}_\epsilon = \frac{1}{n-k} \sum_{j=1}^{n} \boldsymbol{e}_j \boldsymbol{e}_j^\prime ,
\end{equation*}
where \(k\) is the number of estimated parameters and \(n-k\) is the number of degrees of freedom, division by which reduces the bias in the estimation of the covariance matrix.
...
\begin{equation}
    \begin{aligned}
    \mathrm{V}\left(\underline{y_j} | x_{1,j}, \dots, x_{k,j} \right) = & \mathrm{V}\left(\underline{b_0} + \underline{b_1} \underline{x_{1,j}} + \underline{b_2} \underline{x_{2,j}} + \dots + \underline{b_k} \underline{x_{k,j}} + \underline{\epsilon_j}\right) \\
    & \sum_{i=0}^k \underline{x_{i,j}}\underline{\tilde{x}_{i,j}} \mathrm{V}\left(\underline{b_i} \right) + 2 \sum_{i\neq l} \underline{x_{i,j}}\underline{\tilde{x}_{l,j}} \mathrm{cov}\left(\underline{b_i}, \underline{b_l} \right) + \mathrm{V}\left(\underline{\epsilon_j}\right)
    \end{aligned},
...
\begin{equation}
    \begin{aligned}
    \mathcal{V}\left(\underline{y_j} | x_{1,j}, \dots, x_{k,j} \right) = & \sum_{i=0}^k \underline{x_{i,j}}\underline{\tilde{x}_{i,j}} \mathcal{V}\left(\underline{b_i} \right) + 2 \sum_{i\neq l} \underline{x_{i,j}}\underline{\tilde{x}_{l,j}} {cov}\left(\underline{b_i}, \underline{b_l} \right) + \mathcal{V}\left(\underline{\epsilon_j}\right)
    \end{aligned},
...
\hypertarget{assumptions-for-complex-linear-models}{%
\chapter{Assumptions for Complex Linear Models}\label{assumptions-for-complex-linear-models}}
