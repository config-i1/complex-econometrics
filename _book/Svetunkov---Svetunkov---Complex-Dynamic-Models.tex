...
\begin{verbatim}
##             x_r          x_i
## x_r 24.27095639   0.01244257
## x_i  0.01244257 130.24825524
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -70.44608- 7.26130i -39.98186+56.53603i
## y -39.98186+56.53603i  32.68356+65.69111i
\end{verbatim}
...
\begin{equation}
    \begin{aligned}
        & \underline{b_1} = \frac{\sum_{j=1}^n (y_{j}-\hat{\mu}_{y}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})}{\sum_{j=1}^n (x_{j}-\hat{\mu}_{x}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})} \\
...
\begin{equation}
        \underline{b_1} = \frac{\mathrm{cov}(\underline{\tilde{x}}, y)}{\mathrm{cov}(\underline{\tilde{x}},\underline{x})} = \frac{\mathrm{cov}(\underline{\tilde{x}}, \underline{\beta_0} + \underline{\beta_1} \underline{x} + \epsilon)}{\mathrm{cov}(\underline{\tilde{x}},\underline{x})} = \frac{\mathrm{cov}(\underline{\tilde{x}}, \underline{\beta_0}) + \mathrm{cov}(\underline{\tilde{x}}, \underline{\beta_1} \underline{x}) + \mathrm{cov}(\underline{\tilde{x}}, \epsilon)}{\mathrm{cov}(\underline{\tilde{x}},\underline{x})},
    \label{eq:SimpleCLROLSb1Value01}
\end{equation}
which then simplifies to:
\begin{equation}
        \underline{b_1} = \underline{\beta_1} + \frac{\mathrm{cov}(\underline{\tilde{x}}, \epsilon)}{\mathrm{cov}(\underline{\tilde{x}},\underline{x})} = \underline{\beta_1} + \frac{\hat{\sigma}_{x,\epsilon}}{\hat{\sigma}_x^2} ,
...
\begin{equation}
    \begin{aligned}
        & \underline{b_1} = \frac{\sum_{j=1}^n (y_{j}-\hat{\mu}_{y}) ({x}_j-\hat{\mu}_{x})}{\sum_{j=1}^n (x_{j}-\hat{\mu}_{x})^2} \\
        & \underline{b_0} = \frac{1}{n} \sum_{j=1}^n \underline{y_j} - \underline{b_1} \sum_{j=1}^n \underline{x_j} ,
    \end{aligned}
...
\begin{equation}
        \underline{b_1} = \frac{\mathrm{cov}(x,y)}{V(x)} = \frac{\mathrm{cov}(x,\underline{\beta_0} + \underline{\beta_1} x + \epsilon)}{V(x)},
    \label{eq:SimpleCLRCLSb1Expansion01}
\end{equation}
which after some simplifications becomes:
\begin{equation}
        \underline{b_1} = \underline{\beta_1} + \frac{\mathrm{cov}(x, \epsilon)}{V(x)} ,
...
\begin{verbatim}
##            x_r         x_i         y_r         y_i
## x_r 1.00000000  0.03337377  0.68479112  0.70851959
## x_i 0.03337377  1.00000000 -0.70161608  0.72560221
## y_r 0.68479112 -0.70161608  1.00000000 -0.02424438
## y_i 0.70851959  0.72560221 -0.02424438  1.00000000
\end{verbatim}
