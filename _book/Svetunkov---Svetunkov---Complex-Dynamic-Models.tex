...
\end{equation}
we use the \(\underline{}\) symbol below the character to denote the complex variable represented in the form \eqref{eq:complexVectorMatrix}. Finally, given the connection of complex numbers and matrices \eqref{eq:complexNumberMatrix}, the same complex vector \(x\) can be written as a matrix:
\begin{equation}
...
\begin{verbatim}
##           x_r       x_i
## x_r 23.000675 -5.167551
## x_i -5.167551 95.524859
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -62.66459- 1.24336i -30.01901+40.60635i
## y -30.01901+40.60635i  -5.42114+29.55973i
\end{verbatim}
...
\begin{equation}
    \mathbf{y}_j = \mathbf{X}_j \underset{\sim}{\boldsymbol{\beta}} + \boldsymbol{\epsilon}_j .
...
\begin{verbatim}
##            x_r         x_i        y_r       y_i
## x_r 1.00000000  0.02430215  0.7856704 0.7830713
## x_i 0.02430215  1.00000000 -0.5952279 0.6368429
## y_r 0.78567045 -0.59522791  1.0000000 0.2359024
## y_i 0.78307127  0.63684289  0.2359024 1.0000000
\end{verbatim}
