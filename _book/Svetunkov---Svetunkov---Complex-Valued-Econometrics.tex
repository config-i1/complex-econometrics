...
\begin{verbatim}
##           x_r        x_i
## x_r 27.905147  -5.280342
## x_i -5.280342 113.426697
\end{verbatim}
...
\begin{verbatim}
##                     x                  y
## x -63.40234- 7.06004i -29.70563+35.9981i
## y -29.70563+35.99810i  33.04781+44.4145i
\end{verbatim}
...
\begin{verbatim}
##       x_r    x_i    y_r   y_i
## x_r 1.000  0.016  0.713 0.727
## x_i 0.016  1.000 -0.686 0.695
## y_r 0.713 -0.686  1.000 0.042
## y_i 0.727  0.695  0.042 1.000
\end{verbatim}
...
The more useful (at least potentially) property for cAR(p) is the behaviour of the cPACF. This function

Stationarity condition is similar to the AR/VAR: the absolute value of the complex number should be below one for cAR(1). For the other ones\ldots{} it should be unit roots thingy.

What trajectories cAR generates.

If we add the already discussed static elements to \eqref{eq:ComplexAR}, namely \(\underline{\beta}_1 \underline{x}_{1,t} + \dots + \underline{\beta}_{k-1} \underline{x}_{k-1,t}\), then the model will transform into cARX(p), combining the properties of the cLR and cAR.
