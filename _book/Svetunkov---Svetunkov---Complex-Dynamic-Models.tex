...
\begin{verbatim}
##            x_r         x_i
## x_r 32.6278081  -0.3233059
## x_i -0.3233059 111.9171509
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -74.30519- 3.03198i -59.44571+64.10353i
## y -59.44571+64.10353i  13.94328+94.71841i
\end{verbatim}
...
\end{equation}
where every parameter and variable is a complex number, i.e.~\(y = y_{r}+i y_i\), \(x = x_{r}+i x_i\), \(\beta_{j} = \beta_{j,r} + i \beta_{j,i}\) and \(\epsilon = \epsilon_{r} + i \epsilon_i\). Inserting these values in \eqref{eq:SimpleCLRComplex} leads to:
\begin{equation}
    y_r + i y_i = (\beta_{0,r} + i \beta_{0,i}) + (\beta_{1,r} + i \beta_{1,i}) (x_{r}+i x_i) + (\epsilon_r + i \epsilon_i)
    \label{eq:SimpleCLR}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        y_r = & \beta_{0,r} + \beta_{1,r} x_r - \beta_{1,i} x_i + \epsilon_r \\
        y_i = & \beta_{0,i} + \beta_{1,r} x_i + \beta_{1,i} x_r + \epsilon_i
    \end{aligned}
...
\FunctionTok{ccov}\NormalTok{(y,x,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{) }\SpecialCharTok{/} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{cvar}\NormalTok{(x,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{cvar}\NormalTok{(y,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ccov}\NormalTok{(x,y,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{) }\SpecialCharTok{/} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{cvar}\NormalTok{(x,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{cvar}\NormalTok{(y,}\AttributeTok{method=}\StringTok{"conj"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
##            x_r        x_i         y_r        y_i
## x_r  1.0000000 -0.1798727  0.77192461 0.64639353
## x_i -0.1798727  1.0000000 -0.76159109 0.63058867
## y_r  0.7719246 -0.7615911  1.00000000 0.01875677
## y_i  0.6463935  0.6305887  0.01875677 1.00000000
\end{verbatim}
