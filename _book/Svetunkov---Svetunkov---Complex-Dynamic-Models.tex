...
\begin{verbatim}
##           x_r       x_i
## x_r 22.052558  2.249688
## x_i  2.249688 87.660040
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -61.59176- 6.73721i -19.91108+40.44243i
## y -19.91108+40.44243i  24.90726- 2.48686i
\end{verbatim}
...
\caption{\label{tab:scenarios}Several scenarios for the comparison of estimators.}
\centering
\resizebox{\linewidth}{!}{
...
\item
  \(x_r\) and \(x_i\) are \textbf{uncorrelated} and have \textbf{different variances} (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=20\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{uncorrelated} and have \textbf{similar variances} (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\item
  \(x_r\) and \(x_i\) are \textbf{perfectly correlated} (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{uncorrelated} and have \textbf{similar variances} (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\item
  \(x_r\) and \(x_i\) are \textbf{uncorrelated} and have \textbf{the same variances} (\(\sigma_{x_r}=\sigma_{x_i}=20\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{uncorrelated} and have \textbf{the same variances} (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\item
  \(x_r\) and \(x_i\) are \textbf{correlated} with \textbf{different variances} (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{equal to zero} (i.e.~\(x\) and \(y\) have functional relation).
\item
  \(x_r\) and \(x_i\) are \textbf{correlated} with \textbf{different variances} (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{correlated} with \textbf{different variances} (\(\sigma_{\epsilon_r}=10\), \(\sigma_{\epsilon_i}=8\)).
\item
  \(x_r\) and \(x_i\) are \textbf{correlated} with \textbf{different variances} (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)). \(\epsilon_r\) and \(\epsilon_i\) are \textbf{uncorrelated} and have \textbf{similar high variances} (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=100\)).
\end{enumerate}
...
\begin{verbatim}
##            x_r         x_i        y_r       y_i
## x_r 1.00000000  0.01705964  0.7138992 0.7257425
## x_i 0.01705964  1.00000000 -0.6844960 0.6980294
## y_r 0.71389922 -0.68449599  1.0000000 0.0402115
## y_i 0.72574245  0.69802940  0.0402115 1.0000000
\end{verbatim}
