...
\begin{verbatim}
##           x_r       x_i
## x_r 21.918366 -1.563228
## x_i -1.563228 82.658653
\end{verbatim}
...
\begin{verbatim}
##                     x                  y
## x -86.78452+21.69619i -7.11477+69.48584i
## y  -7.11477+69.48584i 49.23183+56.62476i
\end{verbatim}
...
\begin{verbatim}
##            x_r         x_i        y_r        y_i
## x_r 1.00000000  0.09251253  0.6158964  0.7087699
## x_i 0.09251253  1.00000000 -0.7243324  0.7643915
## y_r 0.61589644 -0.72433241  1.0000000 -0.1129345
## y_i 0.70876987  0.76439151 -0.1129345  1.0000000
\end{verbatim}
...
\hypertarget{issues-with-ols-and-cls}{%
\subsection{Issues with OLS and CLS}\label{issues-with-ols-and-cls}}
...
\begin{equation}
    \min S^{\mathrm{OLS}}(\underline{\boldsymbol{b}}) <=> \min (\hat{\sigma}_{e_r}^2 + \hat{\sigma}_{e_i}^2),
...
When it comes to CLS, the criterion \eqref{eq:CLRCLSCriterion} is equivalent to:
\begin{equation}
    \min S^{\mathrm{CLS}}(\underline{\boldsymbol{b}}) = \min \left(\hat{\sigma}_{e_r}^2 - \hat{\sigma}_{e_i}^2 + 2i \hat{\sigma}_{e_r, e_i} \right),
...
Implication: variance of parameters will not be what it needs to be.
