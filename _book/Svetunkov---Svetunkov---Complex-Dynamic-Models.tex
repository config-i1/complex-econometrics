...
\begin{verbatim}
##           x_r       x_i
## x_r 26.230354 -6.379436
## x_i -6.379436 96.432112
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -68.32811+ 8.90980i -23.33205+70.38321i
## y -23.33205+70.38321i  65.27255+52.93900i
\end{verbatim}
...
As can be seen from the Figure \ref{fig:crvCorConjugate} and the value of the conjugate correlation, there is a relation between the two complex variables \(x\) and \(y\), but it although the value of the latter is approximately 0.998+0i, we cannot conclude unambiguously that the relation is strong.
