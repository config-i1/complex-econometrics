...
x1 <- rcnorm(obs, mu=100+150i, sigma2=20)
# Create the explanatory variables
x2 <- rcnorm(obs, mu=150+100i, sigma2=20, varsigma2=5)
# Generate error term from the complex normal distribution
e <- rcnorm(obs, mu=0, sigma2=10, varsigma2=8+5i)
...
Likelihood coincides with OLS... why?!
