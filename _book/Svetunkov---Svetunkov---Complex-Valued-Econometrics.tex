...
\begin{verbatim}
##           x_r        x_i
## x_r 20.995183   5.362004
## x_i  5.362004 119.317411
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -62.02827+ 9.68893i -24.55622+62.80317i
## y -24.55622+62.80317i   0.79207+62.19199i
\end{verbatim}
...
\begin{verbatim}
##        x_r    x_i    y_r   y_i
## x_r  1.000 -0.059  0.788 0.756
## x_i -0.059  1.000 -0.658 0.605
## y_r  0.788 -0.658  1.000 0.196
## y_i  0.756  0.605  0.196 1.000
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{complex}\NormalTok{(}\AttributeTok{real=}\NormalTok{BJsales, }\AttributeTok{imaginary=}\NormalTok{BJsales.lead)}
...
## 
## data:  yScaled
## Dickey-Fuller = -2.1166, Lag order = 5, p-value = 0.5278
...
## 
## data:  yScaled
## KPSS Level = 2.6246, Truncation lag parameter = 4, p-value = 0.01
\end{verbatim}
...
## 
## data:  diff(yScaled)
## Dickey-Fuller = -3.3412, Lag order = 5, p-value = 0.06707
## alternative hypothesis: stationary
\end{verbatim}
...
## 
## data:  diff(yScaled)
## KPSS Level = 0.13477, Truncation lag parameter = 4, p-value = 0.1
\end{verbatim}
...
\FunctionTok{names}\NormalTok{(cARIMABJ) }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{"cARIMA("}\NormalTok{,orders[,}\DecValTok{1}\NormalTok{],}\StringTok{","}\NormalTok{,orders[,}\DecValTok{2}\NormalTok{],}\StringTok{","}\NormalTok{,orders[,}\DecValTok{3}\NormalTok{],}\StringTok{")"}\NormalTok{);}
...
\begin{verbatim}
## cARIMA(3,1,0) estimated via clm()
## Response variable: y
## Loss function used in estimation: likelihood
## Coefficients:
##               Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   0.3040     0.1369     0.0330      0.5750 *
## (Intercept)_i   0.0036     0.0304    -0.0565      0.0637  
## yLag1_r        -0.0878     0.0694    -0.2251      0.0496  
## yLag1_i         0.0644     0.0274     0.0102      0.1186 *
## yLag2_r         0.1457     0.0683     0.0105      0.2808 *
## yLag2_i        -0.0258     0.0202    -0.0657      0.0142  
## yLag3_r         0.2606     0.0938     0.0749      0.4463 *
## yLag3_i        -0.0168     0.0215    -0.0593      0.0257  
## 
## Error covariance matrix:
##         e_r     e_i
## e_r  2.2117 -0.0820
...
## Number of degrees of freedom: 124.5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 544.1991 544.7781 559.9705 561.3796
\end{verbatim}
...
As we see, the model managed to capture the dynamics of the original data well, producing reasonable point forecasts.
