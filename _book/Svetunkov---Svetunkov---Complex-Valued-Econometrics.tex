...
\begin{verbatim}
##          x_r      x_i
## x_r 29.15599  11.6653
## x_i 11.66530 100.4296
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -54.60079+10.39893i -29.53813+55.86023i
## y -29.53813+55.86023i  -4.63998+54.15911i
\end{verbatim}
...
\begin{equation}
    \resizebox{0.85\textwidth}{!}{$
    \begin{aligned}
    \arg({\varrho}_{x,y}) = & \phi_2 - \frac{\phi_1}{2} = \arctan \left( \frac{\sigma_{x_i, y_r} + \sigma_{x_r, y_i}}{\sigma_{x_r, y_r} - \sigma_{x_i, y_i}} \right) - \\
...
\begin{verbatim}
##       x_r    x_i    y_r   y_i
## x_r 1.000  0.023  0.731 0.751
## x_i 0.023  1.000 -0.663 0.675
## y_r 0.731 -0.663  1.000 0.101
## y_i 0.751  0.675  0.101 1.000
\end{verbatim}
