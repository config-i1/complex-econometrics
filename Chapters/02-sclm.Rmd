...
\end{equation}
The variance for the imaginary part will be similar. We do not expand it further, because the formula \@ref(eq:SimpleCLROLSb1Variance) is sufficient for the comparison of OLS with other estimators.
...
\begin{equation}
    ...
    (\#eq:Sigmaest)
\end{equation}
It can be shown that if the \@ref(eq:Sigmaest) is inserted in \@ref(eq:additiveLogLik) then the following concentrated log-likelihood can be obtained [see, for example, @Snyder2017]:
\begin{equation}
