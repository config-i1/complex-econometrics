...
\begin{equation}
    \boldymbol{z} = \begin{pmatrix} x \\ y \end{pmatrix}
    (\#eq:complexNumberVectors)
\end{equation}
or like a matrix:
\begin{equation}
    \underset{\sim}{\boldymbol{z}} = \begin{pmatrix} x & -y \\ y & x \end{pmatrix} ,
...
\begin{equation}
    \boldysymbol{z} \boldysymbol{z}^\prime \begin{pmatrix} x & y \end{pmatrix} \times \begin{pmatrix} x \\ y \end{pmatrix} = \begin{pmatrix} x^2 + y^2 \end{pmatrix}
    (\#eq:complexNumberVectorsMulti)
\end{equation}
and for the matrix:
\begin{equation}
    \underset{\sim}{\boldymbol{z}} \underset{\sim}{\boldymbol{z}}^\prime = \begin{pmatrix} x & -y \\ y & x \end{pmatrix} \times \begin{pmatrix} x & y \\ -y & x \end{pmatrix} = 
...
\begin{equation}
    \underset{\sim}{\boldymbol{z}} \underset{\sim}{\boldymbol{z}}^{\top} = \begin{pmatrix} x & -y \\ y & x \end{pmatrix} \times \begin{pmatrix} x & -y \\ y & x \end{pmatrix} = 
...
\begin{equation}
    f(\mathbf{x}) = \frac{1}{(2 \pi)^{\frac{n}{2}} \sqrt{|\boldsymbol{\Sigma}|}} \exp\left(- \frac{1}{2}
        \begin{pmatrix} \mathbf{x} - \mathbf{\mu} \end{pmatrix}^\top \boldsymbol{\Sigma}^{-1} \begin{pmatrix} \mathbf{x} - \mathbf{\mu} \end{pmatrix}
    \right).
