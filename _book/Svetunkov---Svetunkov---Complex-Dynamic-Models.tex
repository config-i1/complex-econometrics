...
\begin{verbatim}
##          x_r       x_i
## x_r 34.95983  -7.06305
## x_i -7.06305 123.36316
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -69.16204- 8.55094i -54.99090+32.62759i
## y -54.99090+32.62759i -50.96853+63.58958i
\end{verbatim}
...
\begin{verbatim}
##             x_r         x_i        y_r       y_i
## x_r  1.00000000 -0.06643589  0.7981435 0.7627911
## x_i -0.06643589  1.00000000 -0.6504905 0.5900845
## y_r  0.79814351 -0.65049046  1.0000000 0.2243305
## y_i  0.76279111  0.59008448  0.2243305 1.0000000
\end{verbatim}
...
\begin{equation}
    \min S(\underline{\boldsymbol{b}}) = \min \left(\underline{\mathbf{e}}^\top \underline{\mathbf{e}}\right),
...
\begin{equation}
    \mathbf{X}^\prime \mathbf{X} \underline{\boldsymbol{b}} = \mathbf{X}^\prime \mathbf{Y} ,
...
\begin{equation}
    \underline{\boldsymbol{b}} = \left( \mathbf{{X}}^\prime \mathbf{X}\right)^{-1} \mathbf{{X}}^\prime \mathbf{Y}
