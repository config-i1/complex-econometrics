...
\begin{verbatim}
##           x_r       x_i
## x_r 22.442698 -2.866824
## x_i -2.866824 98.313569
\end{verbatim}
...
\begin{verbatim}
##                     x                    y
## x -94.79949+ 0.90034i -66.16865+ 86.53832i
## y -66.16865+86.53832i  31.12061+102.77334i
\end{verbatim}
...
\begin{verbatim}
##        x_r    x_i    y_r   y_i
## x_r  1.000 -0.005  0.712 0.706
## x_i -0.005  1.000 -0.701 0.701
## y_r  0.712 -0.701  1.000 0.012
## y_i  0.706  0.701  0.012 1.000
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# par(mfcol=c(1,2), mar=c(2,2,3,1))}
\CommentTok{\# predict(CLRArtificial, tail(dataArtificial,20),}
        \CommentTok{\# interval="prediction") |\textgreater{}}
    \CommentTok{\# plot()}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Valued-Econometrics_files/figure-latex/unnamed-chunk-31-1.pdf}
\caption{\label{fig:unnamed-chunk-31}Non-linear transformation of a complex variable that changes linearly.}
\end{figure}
