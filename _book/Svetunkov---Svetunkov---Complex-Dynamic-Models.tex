...
\begin{verbatim}
##           x_r       x_i
## x_r 29.263326  3.088609
## x_i  3.088609 99.226158
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -73.58875-19.65499i -44.01403+35.02963i
## y -44.01403+35.02963i   2.56421+35.50259i
\end{verbatim}
...
\begin{verbatim}
##            x_r        x_i         y_r        y_i
## x_r  1.0000000 -0.1250168  0.76461081 0.69041480
## x_i -0.1250168  1.0000000 -0.73187690 0.62875197
## y_r  0.7646108 -0.7318769  1.00000000 0.06608516
## y_i  0.6904148  0.6287520  0.06608516 1.00000000
\end{verbatim}
...
\begin{equation}
    ...
    \end{aligned}
    \label{eq:MCLROLSVariance04}
\end{equation}
where the expectations of each term are equal to zero as long as the classical regression assumptions hold and \(\sigma_{\underline{\epsilon}}^2\) is the conjugate variance of the error term. Similarly, conjugate variance can be calculated for the CLS estimates of parameters, which will result in:
\begin{equation}
    \begin{aligned}
