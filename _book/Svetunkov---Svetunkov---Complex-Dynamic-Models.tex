...
\begin{verbatim}
##           x_r       x_i
## x_r 32.640537 -3.250569
## x_i -3.250569 98.224538
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -88.58611+15.14307i -29.65040+55.95070i
## y -29.65040+55.95070i  24.19633+48.92478i
\end{verbatim}
...
\begin{verbatim}
##       x_r    x_i    y_r   y_i
## x_r 1.000  0.059  0.725 0.753
## x_i 0.059  1.000 -0.642 0.699
## y_r 0.725 -0.642  1.000 0.096
## y_i 0.753  0.699  0.096 1.000
\end{verbatim}
...
\NormalTok{x1 }\OtherTok{\textless{}{-}} \FunctionTok{rcnorm}\NormalTok{(obs, }\AttributeTok{mu=}\DecValTok{100}\SpecialCharTok{+}\NormalTok{150i, }\AttributeTok{sigma2=}\DecValTok{20}\NormalTok{)}
\CommentTok{\# Create the explanatory variables}
\NormalTok{x2 }\OtherTok{\textless{}{-}} \FunctionTok{rcnorm}\NormalTok{(obs, }\AttributeTok{mu=}\DecValTok{150}\SpecialCharTok{+}\NormalTok{100i, }\AttributeTok{sigma2=}\DecValTok{20}\NormalTok{, }\AttributeTok{varsigma2=}\DecValTok{5}\NormalTok{)}
\CommentTok{\# Generate error term from the complex normal distribution}
\NormalTok{e }\OtherTok{\textless{}{-}} \FunctionTok{rcnorm}\NormalTok{(obs, }\AttributeTok{mu=}\DecValTok{0}\NormalTok{, }\AttributeTok{sigma2=}\DecValTok{10}\NormalTok{, }\AttributeTok{varsigma2=}\DecValTok{4}\SpecialCharTok{+}\NormalTok{3i)}
...
## (Intercept)_r  105.8922    11.9307    82.2130    129.5714 *
## (Intercept)_i -154.3177     9.3678  -172.9101   -135.7253 *
## x1_r             2.4651     0.0504     2.3650      2.5652 *
## x1_i             1.5159     0.0396     1.4374      1.5945 *
## x2_r             1.5251     0.0459     1.4339      1.6163 *
## x2_i            -0.7137     0.0361    -0.7853     -0.6421 *
## 
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  119.2748   158.2896  -194.8863    433.4360  
## (Intercept)_i -310.5547   157.1924  -622.5380      1.4286  
## x1_r             3.1496     1.0032     1.1586      5.1407 *
## x1_i             2.1949     1.0101     0.1901      4.1998 *
## x2_r             1.5713     0.2676     1.0403      2.1024 *
## x2_i            -0.8424     0.2623    -1.3630     -0.3218 *
## 
## Error covariance matrix:
##         e_r     e_i
## e_r 13.8499  1.4317
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  105.8916    12.0241    82.0224    129.7608 *
## (Intercept)_i -154.3177     9.4410  -173.0593   -135.5761 *
## x1_r             2.4651     0.0508     2.3642      2.5660 *
## x1_i             1.5159     0.0399     1.4367      1.5952 *
## x2_r             1.5251     0.0463     1.4331      1.6170 *
## x2_i            -0.7137     0.0364    -0.7858     -0.6415 *
## 
## Error covariance matrix:
##        e_r    e_i
## e_r 4.9375 0.7667
...
##      AIC     AICc      BIC     BICc 
## 834.3789 834.9027 846.1021 847.3082
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/unnamed-chunk-30-1.pdf}
\caption{\label{fig:unnamed-chunk-30}Non-linear transformation of a complex variable that changes linearly.}
\end{figure}
...
\NormalTok{b1 }\OtherTok{\textless{}{-}} \FloatTok{2.5} \SpecialCharTok{+} \FloatTok{1.5}\NormalTok{i}
\CommentTok{\# Generate error term from the complex normal distribution}
\NormalTok{e }\OtherTok{\textless{}{-}} \FunctionTok{complex}\NormalTok{(}\AttributeTok{real=}\FunctionTok{rnorm}\NormalTok{(obs, }\DecValTok{0}\NormalTok{, }\FloatTok{0.1}\NormalTok{), }\AttributeTok{imaginary=}\FunctionTok{rnorm}\NormalTok{(obs, }\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{))}
\CommentTok{\# e \textless{}{-} rcnorm(obs, 0, sigma2=0.25, varsigma2=0.16+0.09i)}
...
\NormalTok{complexData }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\AttributeTok{y=}\NormalTok{y,}\AttributeTok{x=}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/nonlinearLinStdResid-1.pdf}
...
\NormalTok{complexDataLogs }\OtherTok{\textless{}{-}} \FunctionTok{log}\NormalTok{(complexData)}
\CommentTok{\# Apply a model to log data}
\NormalTok{complexModelLogs }\OtherTok{\textless{}{-}} \FunctionTok{clm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{x, complexDataLogs)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/nonlinearStdResid-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/heteroDiagnostics-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1ACFConj-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1PACFConj-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1ACFDir-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1PACFDir-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1Pearson-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexAR1Ploar-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexARDiagnosticsACFPACF-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/complexNormDiagnostics-1.pdf}
...
\CommentTok{\# Create the explanatory variables}
\NormalTok{x1 }\OtherTok{\textless{}{-}} \FunctionTok{complex}\NormalTok{(}\AttributeTok{real=}\FunctionTok{rnorm}\NormalTok{(obs,}\DecValTok{100}\NormalTok{,}\DecValTok{10}\NormalTok{), }\AttributeTok{imaginary=}\FunctionTok{rnorm}\NormalTok{(obs,}\DecValTok{50}\NormalTok{,}\DecValTok{5}\NormalTok{))}
\CommentTok{\# Generate error term from the complex normal distribution}
\NormalTok{e }\OtherTok{\textless{}{-}} \FunctionTok{complex}\NormalTok{(}\AttributeTok{real=}\FunctionTok{rnorm}\NormalTok{(obs, }\DecValTok{0}\NormalTok{, }\DecValTok{20}\NormalTok{), }\AttributeTok{imaginary=}\FunctionTok{rnorm}\NormalTok{(obs, }\DecValTok{0}\NormalTok{, }\DecValTok{30}\NormalTok{))}
...
##        y    x1    x2
## y  1.000 0.878 0.878
## x1 0.878 1.000 0.999
## x2 0.878 0.999 1.000
\end{verbatim}
...
\begin{verbatim}
##               y         x1            x2
## y  1.000+0.000i 1.1-0.068i  1.099-0.068i
## x1 1.100-0.068i 1.0+0.000i  1.000+0.001i
## x2 1.099-0.068i 1.0+0.001i -1.000+0.000i
\end{verbatim}
...
##        y    x1    x2
## y  1.000 0.939 0.938
## x1 0.939 1.000 1.000
## x2 0.938 1.000 1.000
\end{verbatim}
...
## y_r   1.000 0.315  0.924 -0.220  0.898 0.796
## y_i   0.315 1.000  0.489  0.579  0.158 0.681
## x1_r  0.924 0.489  1.000 -0.060  0.890 0.928
## x1_i -0.220 0.579 -0.060  1.000 -0.505 0.316
## x2_r  0.898 0.158  0.890 -0.505  1.000 0.657
## x2_i  0.796 0.681  0.928  0.316  0.657 1.000
\end{verbatim}
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   71.5012    22.0345    27.7689    115.2335 *
## (Intercept)_i -126.3063    32.6150  -191.0380    -61.5747 *
## x1_r             1.2877     4.7501    -8.1399     10.7152  
## x1_i             3.4833     7.0309   -10.4712     17.4377  
## x2_r             1.0787     2.3923    -3.6692      5.8267  
## x2_i            -2.0108     3.5410    -9.0387      5.0170  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  470.3931 -110.8792
## e_i -110.8792 1030.5972
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  125.4156    40.9986    44.0448    206.7864 *
## (Intercept)_i -115.6256    43.7340  -202.4254    -28.8258 *
## x1_r             1.0558     6.6146   -12.0724     14.1839  
## x1_i             3.9269     5.4656    -6.9208     14.7745  
## x2_r             0.8794     2.4126    -3.9089      5.6678  
## x2_i            -2.0261     3.5830    -9.1374      5.0852  
## 
## Error covariance matrix:
##           e_r      e_i
## e_r  477.2509 -105.279
## e_i -105.2790 1054.208
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{clm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{., data1, }\AttributeTok{loss=}\StringTok{"like"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   74.3405    22.1671    30.3363    118.3447 *
## (Intercept)_i -121.8535    32.9013  -187.1664    -56.5405 *
## x1_r             1.2660     4.7786    -8.2201     10.7522  
## x1_i             3.4843     7.0927   -10.5954     17.5641  
## x2_r             1.0635     2.4067    -3.7139      5.8410  
## x2_i            -2.0121     3.5721    -9.1031      5.0788  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  476.0707 -112.9427
## e_i -112.9427 1048.7737
## 
## Sample size: 100
## Number of estimated parameters: 4.5
## Number of degrees of freedom: 95.5
## Information criteria:
##      AIC     AICc      BIC     BICc 
## 1876.874 1877.398 1888.597 1889.803
\end{verbatim}
...
##        y    x1    x2
## y  1.000 0.782 0.725
## x1 0.782 1.000 0.857
## x2 0.725 0.857 1.000
\end{verbatim}
...
\begin{verbatim}
##               y           x1           x2
## y  1.000+0.000i 1.208+0.065i 1.302+0.157i
## x1 1.208+0.065i 1.000+0.000i 1.197+0.009i
## x2 1.302+0.157i 1.197+0.009i 1.000+0.000i
\end{verbatim}
...
##        y    x1    x2
## y  1.000 0.901 0.897
## x1 0.901 1.000 0.997
## x2 0.897 0.997 1.000
\end{verbatim}
...
\begin{verbatim}
##         y_r    y_i   x1_r   x1_i   x2_r  x2_i
## y_r   1.000 -0.022  0.902 -0.137  0.899 0.086
## y_i  -0.022  1.000  0.073  0.453  0.074 0.190
## x1_r  0.902  0.073  1.000 -0.060  0.997 0.034
## x1_i -0.137  0.453 -0.060  1.000 -0.059 0.020
## x2_r  0.899  0.074  0.997 -0.059  1.000 0.028
## x2_i  0.086  0.190  0.034  0.020  0.028 1.000
\end{verbatim}
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   73.2762    27.0508    19.5880    126.9645 *
## (Intercept)_i -160.6063    40.0563  -240.1069    -81.1057 *
## x1_r             3.2671     0.3720     2.5289      4.0053 *
## x1_i             0.9657     0.5508    -0.1275      2.0588  
## x2_r             0.9244     0.2943     0.3403      1.5085 *
## x2_i            -0.4967     0.4358    -1.3617      0.3682  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  463.7618 -113.0148
## e_i -113.0148 1016.8977
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   91.3839    33.1621    25.5664    157.2014 *
## (Intercept)_i -158.1041    43.5358  -244.5105    -71.6977 *
## x1_r             3.1602     0.5611     2.0465      4.2739 *
## x1_i             1.0456     0.4027     0.2464      1.8448 *
## x2_r             0.8972     0.4414     0.0212      1.7732 *
## x2_i            -0.5347     0.3303    -1.1902      0.1208  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  464.1529 -112.6807
## e_i -112.6807 1019.1710
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r   79.9056    31.5267    17.3338    142.4773 *
## (Intercept)_i -129.0633    46.8310  -222.0099    -36.1167 *
## x1_r             2.7000     0.3798     1.9462      3.4537 *
## x1_i             1.3239     0.5641     0.2043      2.4436 *
## x2_r             1.4046     0.2995     0.8102      1.9990 *
## x2_i            -0.6829     0.4449    -1.5659      0.2001  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  468.3421 -110.6171
## e_i -110.6171 1033.4129
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
...
## Coefficients:
##                Estimate Std. Error Lower 2.5% Upper 97.5%  
## (Intercept)_r  135.0530    37.8927    59.8465    210.2596 *
## (Intercept)_i -136.4550    51.9941  -239.6490    -33.2610 *
## x1_r             2.4171     0.5796     1.2667      3.5675 *
## x1_i             1.5748     0.4205     0.7402      2.4093 *
## x2_r             1.3666     0.3395     0.6928      2.0404 *
## x2_i            -0.5815     0.4567    -1.4879      0.3249  
## 
## Error covariance matrix:
##           e_r       e_i
## e_r  475.0296 -103.1247
## e_i -103.1247 1052.5370
## 
## Sample size: 100
## Number of estimated parameters: 3
## Number of degrees of freedom: 97
