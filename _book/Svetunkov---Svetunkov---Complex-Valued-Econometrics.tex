...
\begin{verbatim}
##            x_r         x_i
## x_r 27.5923111  -0.2460132
## x_i -0.2460132 106.6244244
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -61.29668- 3.47543i -16.67425+44.30178i
## y -16.67425+44.30178i  28.02946+15.77893i
\end{verbatim}
...
\begin{verbatim}
##        x_r    x_i    y_r    y_i
## x_r  1.000 -0.053  0.678  0.626
## x_i -0.053  1.000 -0.765  0.743
## y_r  0.678 -0.765  1.000 -0.143
## y_i  0.626  0.743 -0.143  1.000
\end{verbatim}
...
Selection of orders based on cACF/cPACF is extremely difficult, because of all the possibilities for their behaviour depending on the order of the model and/or specific values of parameters. For example, in some situations cACF will decline harmonically for an AR(p) process, while cPACF will do the same for an MA(q) one. Their combination might produce really puzzling cACF/cPACF, which might become useless for the order selection. As a result, we recommend using other principles for the selection of the appropriate p and q.
