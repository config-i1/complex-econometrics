...
\begin{verbatim}
##             x_r         x_i
## x_r 25.49223394  0.09548853
## x_i  0.09548853 92.84282945
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -73.59044+ 0.62837i -28.16197+63.83996i
## y -28.16197+63.83996i  25.56226+ 3.35798i
\end{verbatim}
...
\begin{verbatim}
##             x_r         x_i         y_r        y_i
## x_r  1.00000000 -0.06976079  0.74190311 0.69368181
## x_i -0.06976079  1.00000000 -0.71736766 0.66609364
## y_r  0.74190311 -0.71736766  1.00000000 0.03700096
## y_i  0.69368181  0.66609364  0.03700096 1.00000000
\end{verbatim}
...
\hypertarget{omitted-variables-in-case-of-ols-estimation}{%
\subsubsection{Omitted variables in case of OLS estimation}\label{omitted-variables-in-case-of-ols-estimation}}

We refer to the derivations \eqref{eq:MCLROLSExpansion}, which given \eqref{eq:AssumptionsOmitTrueModel} can be substituted to:
\begin{equation}
    \begin{aligned}
    \underline{\boldsymbol{b}}^{\text{OLS}} =
        & \left( \underline{\mathbf{X}}^\prime \underline{\mathbf{X}} \right)^{-1} \underline{\mathbf{X}}^\prime \underline{\mathbf{y}} = \\
