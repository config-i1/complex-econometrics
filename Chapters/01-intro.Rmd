...
```{r crvNormalExample, fig.height=4, fig.width=4, fig.cap="Visual representation of variances for a c.r.v. that follows Complex Normal distribution.", echo=FALSE}
xr <- rnorm(1000, 100, 10)
xi <- xr + rnorm(1000, 0, 10)
x <- complex(real=xr, imaginary=xi)
plot(x, col="lightblue", xlim=c(70, 130), ylim=c(70,130))
