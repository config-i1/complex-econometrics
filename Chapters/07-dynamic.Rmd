...
\end{equation}
where we now can produce future $\hat{\underline{y}}_t$ directly instead of $\hat{\Delta}_{\underline{y}_t}$.
...
What taking differences means, how it is implemented in `complex`
