...
While the first two groups of assumptions are universal for any statistical model, the third group has some special implications in case of CLR. Transformation of separate parts or the whole variable...
...
4. Residuals follow a circular distribution;
5. The residuals follow an assumed distribution;
6. The distribution of the residuals does not change over time.
