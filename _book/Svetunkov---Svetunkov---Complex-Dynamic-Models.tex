...
\begin{verbatim}
##           x_r        x_i
## x_r 25.024991   3.575565
## x_i  3.575565 113.949840
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -91.38410+11.11976i -34.22323+75.70742i
## y -34.22323+75.70742i  62.41384+54.18499i
\end{verbatim}
...
\end{equation}
Comparing \eqref{eq:SimpleCLRCLSb1Variance} with \eqref{eq:SimpleCLROLSb1Variance}, we can conclude that the estimates of parameters via CLS are in general less than or equally efficient as the estimates via OLS. There are some cases, when the variance \eqref{eq:SimpleCLRCLSb1Variance} is much higher than \eqref{eq:SimpleCLROLSb1Variance}. For example, when the real and imaginary parts of \(x\) are not correlated (i.e.~\(\hat{\sigma}_{x_r, x_i}=0\)) and when the variances of the real and imaginary parts of \(x\) are equal, the variance of \(b_{1,r}\) explodes. In the opposite situation, when \(\hat{\sigma}_{x_r, x_i} \neq 0\) and \(\hat{\sigma}_{x_r}^2 \neq \hat{\sigma}_{x_i}^2\), the variance \eqref{eq:SimpleCLRCLSb1Variance} will typically be greater or equal to the variance of \eqref{eq:SimpleCLROLSb1Variance}. So, we can conclude that in general CLS produces less efficient estimates of parameters than OLS for the simple CLR.
...
\begin{verbatim}
##            x_r        x_i         y_r         y_i
## x_r  1.0000000 -0.0451660  0.71278451  0.69119678
## x_i -0.0451660  1.0000000 -0.72981869  0.68793861
## y_r  0.7127845 -0.7298187  1.00000000 -0.01059836
## y_i  0.6911968  0.6879386 -0.01059836  1.00000000
\end{verbatim}
