...
\begin{verbatim}
##          x_r       x_i
## x_r 24.42236  -1.22955
## x_i -1.22955 102.97686
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -90.31278+ 7.33985i -40.76718+70.59265i
## y -40.76718+70.59265i  46.91168+87.97859i
\end{verbatim}
...
\item
  \(x_r\) and \(x_i\) are uncorrelated and have different variances (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=20\)), \(\epsilon_r\) and \(\epsilon_i\) are uncorrelated and have similar variances (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\item
  \(x_r\) and \(x_i\) are perfectly correlated (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)), \(\epsilon_r\) and \(\epsilon_i\) are uncorrelated and have similar variances (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\item
  \(x_r\) and \(x_i\) are correlated with different variances (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)), \(\epsilon_r\) and \(\epsilon_i\) are equal to zero (i.e.~\(x\) and \(y\) have functional relation).
\item
  \(x_r\) and \(x_i\) are correlated with different variances (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)), \(\epsilon_r\) and \(\epsilon_i\) are correlated with different variances.
\item
  \(x_r\) and \(x_i\) are correlated with different variances (\(\sigma_{x_r}=10\), while \(\sigma_{x_i}=15\)), \(\epsilon_r\) and \(\epsilon_i\) are uncorrelated and have similar high variances (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=100\)).
\item
  \(x_r\) and \(x_i\) are uncorrelated and have the same variances (\(\sigma_{x_r}=\sigma_{x_i}=20\)), \(\epsilon_r\) and \(\epsilon_i\) are uncorrelated and have the same variances (\(\sigma_{\epsilon_r}=\sigma_{\epsilon_i}=1.5\)).
\end{enumerate}
...
\NormalTok{parametersValues }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\FunctionTok{c}\NormalTok{(nsim,}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{),}
                          \AttributeTok{dimnames=}\FunctionTok{list}\NormalTok{(}\ConstantTok{NULL}\NormalTok{,}
...
\caption{\label{fig:parametersFR}Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of \(b_1=2-1.5i\) (orange horizontal lines on the plot). Scenario 3.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/parametersCorError-1.pdf}
\caption{\label{fig:parametersCorError}Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of \(b_1=2-1.5i\) (orange horizontal lines on the plot). Scenario 4.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/parametersHVError-1.pdf}
\caption{\label{fig:parametersHVError}Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of \(b_1=2-1.5i\) (orange horizontal lines on the plot). Scenario 5.}
\end{figure}

\begin{figure}
\centering
\includegraphics{Svetunkov---Svetunkov---Complex-Dynamic-Models_files/figure-latex/parametersUCSV-1.pdf}
\caption{\label{fig:parametersUCSV}Estimation of parameters using OLS, CLS and likelihood and their convergence to the true value of \(b_1=2-1.5i\) (orange horizontal lines on the plot). Scenario 6.}
\end{figure}

Ratio of variances for several sample sizes\ldots{}
...
\begin{verbatim}
##            x_r         x_i        y_r        y_i
## x_r 1.00000000  0.07079749  0.5924340  0.6547824
## x_i 0.07079749  1.00000000 -0.7595389  0.7981079
## y_r 0.59243401 -0.75953886  1.0000000 -0.2179970
## y_i 0.65478238  0.79810791 -0.2179970  1.0000000
\end{verbatim}
