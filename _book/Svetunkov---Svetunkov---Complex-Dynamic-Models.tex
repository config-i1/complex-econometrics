...
\begin{verbatim}
##            x_r         x_i
## x_r 27.0840110  -0.4053785
## x_i -0.4053785 106.6991180
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -72.26276+ 7.76961i -25.58773+63.67208i
## y -25.58773+63.67208i  38.79828+61.95183i
\end{verbatim}
...
\begin{verbatim}
##           x_r        x_i         y_r         y_i
## x_r 1.0000000  0.0311207  0.68807457  0.70583418
## x_i 0.0311207  1.0000000 -0.70062557  0.72700034
## y_r 0.6880746 -0.7006256  1.00000000 -0.02468684
## y_i 0.7058342  0.7270003 -0.02468684  1.00000000
\end{verbatim}
...
\begin{equation*}
    y_{r} + i y_{i} = (\beta_{0,r} + i \beta_{0,i}) (x_{1,r} + i x_{1,i}) ^{\beta_{1,r} + i \beta_{1,i}} \dots (x_{k-1,r} + i x_{k-1,i}) ^{\beta_{k-1,r} + i \beta_{k-1,i}} (\epsilon_{r} + i \epsilon_{i})
\end{equation*}
can be linearised using natural logarithm to:
\begin{equation*}
    \ln (y_{r} + i y_{i}) = \ln (\beta_{0,r} + i \beta_{0,i}) + (\beta_{1,r} + i \beta_{1,i}) \ln(x_{1,r} + i x_{1,i}) + \dots + (\beta_{k-1,r} + i \beta_{k-1,i}) \ln (x_{k-1,r} + i x_{k-1,i}) + \ln (\epsilon_{r} + i \epsilon_{i}),
\end{equation*}
