...
## Modelling with complex variables
Now that we have discussed basics of complex variables theory, we can discuss the modelling aspects of complex-valued models. This includes what can be included in the real and the imaginary parts of the complex variable in what form and how this can be modelled.

What can be included and how. Examples
