...
\begin{verbatim}
##           x_r        x_i
## x_r 24.081293  -3.728913
## x_i -3.728913 107.242965
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -51.47249- 8.63222i -19.04062+35.09854i
## y -19.04062+35.09854i   8.61649+38.03286i
\end{verbatim}
...
\textbf{Derive variance of estimator}
...
\begin{equation}
    ...
    \label{eq:SimpleCLRCLSSlopeExpansion03}
\end{equation}
Note that both numerator and denominator of \eqref{eq:SimpleCLRCLSSlopeExpansion03} are complex numbers. In order to have a proper split into real and imaginary parts we need to multiply the fraction by the complex number conjugate to the denominator:
\begin{equation}
    ...
    \label{eq:SimpleCLRCLSSlopeExpansion04}
\end{equation}
...
\begin{equation}
    ...
    \end{aligned}
    \label{eq:SimpleCLRCLSSlopeExpansion05}
\end{equation}
or
\begin{equation}
    \begin{aligned}
    ...
    \end{aligned}
    \label{eq:SimpleCLRCLSSlopeExpansion06}
\end{equation}
...
\item
  \textbf{Derive expectation of estimator}
\item
  \textbf{Derive variance of estimator}
\item
  \textbf{Compare with OLS}
\end{enumerate}
...
\begin{verbatim}
##            x_r        x_i        y_r        y_i
## x_r  1.0000000 -0.0904284  0.7031154  0.6327026
## x_i -0.0904284  1.0000000 -0.7689123  0.7108948
## y_r  0.7031154 -0.7689123  1.0000000 -0.1011402
## y_i  0.6327026  0.7108948 -0.1011402  1.0000000
\end{verbatim}
