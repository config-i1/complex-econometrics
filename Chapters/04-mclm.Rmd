...
1. Construct confidence intervals of parameters;
2. Test hypothesis about each of parameters;
3. Test hypothesis for each complex parameter (considering joint distribution);
