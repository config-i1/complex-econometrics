...
\begin{verbatim}
##          x_r       x_i
## x_r 34.34173   2.64855
## x_i  2.64855 127.48266
\end{verbatim}
...
\begin{verbatim}
##                     x                   y
## x -72.80162-13.30436i -44.63569+37.32561i
## y -44.63569+37.32561i -28.13072+43.15328i
\end{verbatim}
...
\end{equation}
The residuals can be substituted as: \(\underline{e_j} = \underline{y_j} - \underline{b_0} - \underline{b_1} \underline{x_j}\) and \(\underline{\tilde{e}_j} = \underline{\tilde{y}_j} - \underline{\tilde{b}_0} - \underline{\underline{\tilde{b}_1}} \underline{\tilde{x}_j}\) to get:
\begin{equation}
...
\begin{equation}
    \begin{aligned}
        & - \sum_{j=1}^n \underline{y_j} - \sum_{j=1}^n \underline{\tilde{y}_j} + 2 n b_{0,r} + \underline{\tilde{b}_1} \sum_{j=1}^n \underline{\tilde{x}_j} + {b}_1 \sum_{j=1}^n {x}_j = 0 \\
        & i \sum_{j=1}^n \underline{y_j} - i \sum_{j=1}^n \underline{\tilde{y}_j} + 2 n b_{0,i} + i \underline{\tilde{b}_1} \sum_{j=1}^n \underline{\tilde{x}_j} - i {b}_1 \sum_{j=1}^n {x}_j = 0 \\
...
\begin{equation}
    \begin{aligned}
        & b_{1} = \frac{\sum_{j=1}^n (y_{j}-\hat{\mu}_{y}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})}{\sum_{j=1}^n (x_{j}-\hat{\mu}_{x}) (\underline{\tilde{x}_j}-\hat{\tilde{\mu}}_{x})} \\
...
\begin{equation}
    \begin{aligned}
        ...
        & \underline{b_0} = \hat{\mu}_{y} - \underline{b_1} \hat{\mu}_{x} .
    \end{aligned}
...
As for the variance of \(\underline{b_1}\), it can be shown to be equal to:
\begin{equation}
...
\begin{equation}
    \begin{aligned}
        & \frac{d \sum_{j=1}^n (\underline{e_j}^2)}{d b_{0}} = 0 \\
        & \frac{d \sum_{j=1}^n (\underline{e_j}^2)}{d b_{1}} = 0 .
    \end{aligned}
...
\begin{verbatim}
##             x_r         x_i        y_r        y_i
## x_r  1.00000000 -0.03672649  0.6915815  0.6707954
## x_i -0.03672649  1.00000000 -0.7444332  0.7133075
## y_r  0.69158154 -0.74443318  1.0000000 -0.0674960
## y_i  0.67079541  0.71330746 -0.0674960  1.0000000
\end{verbatim}
