...
Finally, we focused this monograph on complex-valued models that have two real valued variables in the complex response one. But this is not the only way of modelling using complex variables. @Svetunkov2012 discussed some other ways of modelling which lie outside of this monograph.
