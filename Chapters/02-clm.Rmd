...
As can be seen from the plot in Figure \@ref(fig:crvCorConjugateMDS) and the value of Pearson's correlation coefficient above, it seems that the variables indeed exhibit a strong linear relation. So, the conjugate correlation has provided an adequate information about it.
