...
\begin{equation}
    ...
    (\#eq:SimpleCLRComplex)
\end{equation}
where every parameter and variable is a complex number, i.e. $y = y_{r}+i y_i$, $x = x_{r}+i x_i$, $b_{j} = b_{j,r} + i b_{j,i}$ and $\epsilon = \epsilon_{r} + i \epsilon_i$. Inserting these values in \@ref(eq:SimpleCLRComplex) leads to:
\begin{equation}
