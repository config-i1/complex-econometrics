...
1. The magnitude of the coefficient will be equal to zero only when $\sigma_{x_i,y_r}=\sigma_{x_r,y_i}=0$ and $\sigma_{x_r,y_r}=\sigma_{x_i,y_i}$. One of the special cases of this is when all covariances between the real and imaginary parts of $x$ and $y$ are equal to zero.
