...
```{r complexPlaneCircle, fig.width=4, fig.height=4, fig.cap="Comparison of two complex numbers $z_1$ and $z_2$ that have the same magnitude $r$, but different angles.", echo=FALSE}
par(mar=c(1,1,1,1), cex=1.25, cex.lab=1/1.25)
plot(c(0,9),c(0,6), type="l",
     xlab="", ylab="",
